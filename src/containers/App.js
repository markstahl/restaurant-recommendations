...
class App extends Component {
  ...
  submitReview(submission) {
    ...
    this.setState( {reviews: currentReviews.concat(submission)} )
    console.log(currentReviews.concat(submission))
  }
      ...
      <div>
        <div className="row">
          ...
          <div className="small-9 columns">
            ...
            <FormContainer handler={this.submitReview} selected={this.state.selectedId}/>
          </div>
        </div>
      </div>
    )
